...
RUN apt-get update && apt-get install -y --no-install-recommends python3 python3-pip python3-setuptools python3-dev \    
    libpng-dev python3-opencv libhdf5-dev libatlas-base-dev libtiff5 libjpeg62 libsm6 libxext6 libxrender-dev libwebp-dev libglib2.0-0 make automake gcc g++ 
